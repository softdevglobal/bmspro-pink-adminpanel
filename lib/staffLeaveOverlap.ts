...
/**
 * Approved leave blocks a booking on `bookingYmd` (YYYY-MM-DD) in branch local wall time,
 * between bookingStartMinutes and bookingEndMinutes (exclusive end same convention as bookings).
 */
