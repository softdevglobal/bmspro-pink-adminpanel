              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" placeholder="Pink Salon Co." />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">ABN</label>
                        <input className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" placeholder="00 000 000 000" />
                      </div>
                      <div className="sm:col-span-2">
                        <label className="block text-sm font-medium text-slate-700 mb-2">Address</label>
                        <textarea rows={3} className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" placeholder="Street, City, Postcode" />
                      </div>
                    </div>
                    <div className="mt-4 flex justify-end">
                      <button className="px-5 py-2.5 bg-pink-600 text-white rounded-lg font-semibold hover:bg-pink-700">Save Profile</button>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select className="w-full px-4 py-3 border border-slate-300 rounded-lg bg-white focus:ring-2 focus:ring-pink-500">
                    ...
                    <div className="mt-4 flex justify-end">
                      <button className="px-5 py-2.5 bg-pink-600 text-white rounded-lg font-semibold hover:bg-pink-700">Save Rules</button>
                    </div>
                  </div>
                </section>
                ...
                <aside className="space-y-6">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-6">
                    ...
                    <div className="mt-4 flex justify-end">
                      <button className="px-5 py-2.5 bg-pink-600 text-white rounded-lg font-semibold hover:bg-pink-700">Save Notifications</button>
                    </div>
                  </div>
                </aside>
              </div>
